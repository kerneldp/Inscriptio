...
--
-- Host: localhost:8889
-- Generation Time: May 11, 2026 at 02:55 AM
...
(5, 3, 1, 'uploads/stu3_20260511025254_original.png', 'uploads/stu3_20260511025254_shap.png', 'uploads/stu3_20260511025254_gradcam.png', 'uploads/stu3_20260511025254_severe.png', '[{\"patch_num\": 1, \"pd_prob\": 55.1, \"label\": \"Dysgraphic (PD)\", \"confidence\": 55.1}, {\"patch_num\": 2, \"pd_prob\": 58.2, \"label\": \"Dysgraphic (PD)\", \"confidence\": 58.2}, {\"patch_num\": 3, \"pd_prob\": 63.9, \"label\": \"Dysgraphic (PD)\", \"confidence\": 63.9}]', 'The predictive anomalies are heavily localized in the whitespace between characters. Deuel (1995) defines Spatial Dysgraphia as producing illegible writing - whether spontaneous or copied - due to a fundamental deficit in spatial perception, which manifests directly as abnormal letter spacing and erratic kerning. Chung et al. (2020) further specify that in spatial dysgraphia, oral spelling and fine-motor tapping speed are preserved, indicating that the spacing irregularities detected in this zone are perceptual-spatial in origin rather than purely motoric. These atypical inter-character intervals are a strong behavioral marker of impaired graphomotor coordination, consistent with Specific Learning Disorder criteria (APA, 2013). Döhla and Heim (2016) additionally note that dysgraphia and dyslexia share spatial-processing deficits that manifest during the physical execution of written output.', 0.5906, 'Potential', NULL, NULL, NULL, '2026-05-11', 0, NULL, '2026-05-11 02:52:55');
